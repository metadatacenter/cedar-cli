...
class ModeRuntimeSafetyTest(unittest.TestCase):
    ...
    def test_docker_rejects_running_native_services(self, _native):
    ...
    def test_hybrid_allows_running_native_frontends(self, _native):
        self.assertEqual(
            CedarMode.HYBRID,
    ...
    def test_hybrid_rejects_a_running_native_backend(self, _native):
